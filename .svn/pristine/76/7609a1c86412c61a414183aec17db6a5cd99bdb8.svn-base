			...
			if(status>0) {
				...
				if(status>0) {
					...
					myMailVO.setEmailContent(
							"<html><body><h3>안녕하세요. BORDER7입니다.</h3>신고서 접수가 완료되어 안내 메일 드립니다."
							...
							+ contractNo
							+ "</td></tr><tr><th style=\"border: 1px solid #dddddd; text-align: center; padding: 8px; background-color: #f2f2f2;\">신고서접수완료일시</th>"
							+ "<td style=\"border: 1px solid #dddddd; text-align: left; padding: 8px;\">"
							+ receptDateStr
							+ "</td></tr><tr><th style=\"border: 1px solid #dddddd; text-align: center; padding: 8px; background-color: #f2f2f2;\">업무완료예정일시</th>"
							+ "<td style=\"border: 1px solid #dddddd; text-align: left; padding: 8px;\">"
							+ antcDateStr
