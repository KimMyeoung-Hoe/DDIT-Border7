		...
		<main class="main-content-area">
			...
			<div class="breadcrumb-warp">
		      <div class="col-sm-12">
		         <ol class="breadcrumb">
		            ...
		            <li class="breadcrumb-item"><a href="/servant/customsDeclaration.do">수입 통관 신고</a></li>
		            <li class="breadcrumb-item"><a href="/servant/adminWork.do">수입 신고 상세</a></li>
		            <li class="breadcrumb-item"><a href="/servant/adminWork.do">수입 필증 발급</a></li>
		         </ol>
		      </div>
		    </div>
		    
			<div class="content-header">
				<div class="content-title">수입신고필증 발급</div>
				<p class="desc">수입신고필증 발급 페이지 입니다.</p>
		    ...
		    <div style="background: #ffffff !important; border-radius: 12px; padding: 30px; backdrop-filter: blur(5px); border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.37); width: 100%; box-sizing: border-box; margin-bottom: 30px;">
                ...
                <div class="btn-container" style="margin:30px 0 0 0;">
			    	...
			    	<input class="btn btn-primary btn-c" type="button" id="cdWriteBtn" onclick="" value="완료" style="border: none; border-radius: 8px; font-size: 16px !important; font-weight: bold; transition: background-color 0.2s, transform 0.1s; width: 160px; height: 48px; background-color: #007bff; color: white;">
			    </div>
		    </div>
		    </form>
	    </main>
