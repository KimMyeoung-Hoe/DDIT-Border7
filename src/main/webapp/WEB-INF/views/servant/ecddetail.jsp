	...
	<div class="app-container">
		<main class="main-content-area">
			<div class="content-header">
				<div class="content-title">수출신고필증</div>
				<p class="desc">수출신고필증은 수출신고서에 전자직인을 날인하여 수입통관 신고가 완료되었음을 증명하는 문서입니다.</p>
			</div>
			<form action="/pdf/download2.do" id="pdfDownFrom" method="get">
				<input type="hidden" name="url" value="servant/cdDetail.do?contractNo=${contractVO.contractNo }&declNo=${declNo }"/>
