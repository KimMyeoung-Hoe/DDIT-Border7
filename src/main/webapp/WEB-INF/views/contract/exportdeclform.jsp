				...
				<div class="breadcrumb-warp">
					<div class="col-sm-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#">수출신고서 작성</a></li>
						</ol>
					</div>
				</div>
				...
				<div class="section">
			        ...
			        <table class="info-table">
			            ...
			            <tr>
			                ...
			                <c:set var="getDateEssential">
			                	<c:choose>
									<c:when test="${not empty contractVO.declDVO.limitOnBoard}">
							            <fmt:formatDate value="${contractVO.declDVO.limitOnBoard}" pattern="yyyy-MM-dd"/>
							        </c:when>
							        <c:otherwise>
							        	<jsp:useBean id="currentDateForCalc" class="java.util.Date" />
								        <%
									        Calendar calEssential = Calendar.getInstance();
							                calEssential.setTime((java.util.Date)pageContext.findAttribute("currentDateForCalc"));
							                calEssential.add(Calendar.DATE, 30); // Add 30 days
							                pageContext.setAttribute("calculatedFutureDate", calEssential.getTime());
										%>
							            <fmt:formatDate value="${calculatedFutureDate }" pattern="yyyy-MM-dd"/>
							        </c:otherwise>
								</c:choose>
			                </c:set>
			                <td><input name="limitOnBoard" id="limitOnBoard" type="date" 
			                	value="${getDateEssential }"/>
			                </td>
						</tr>
			        </table>
			        ...
			        <table class="info-table">
		                <tr>
		                    ...
		                    <td><fmt:formatNumber value="${contractVO.declDVO.customsValue }" pattern="###,###,###,### 원" /></td>
		                    <th>관세율</th>
