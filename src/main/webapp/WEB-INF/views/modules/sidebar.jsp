    ...
    <nav class="nav-menu">
	       ...
	       <div class="nav-item" data-menu-id="support-main">
	        ...
	        <div class="sub-menu">
	            ...
	            <div class="nav-item" data-menu-id="faq" onclick="goFAQ()">
	                <span class="nav-item-icon">⁉️</span> 자주 찾는 질문
	            </div>
	        </div>
		</sec:authorize>
		<!-- 비로그인 -->
		...
		<sec:authorize access="hasRole('ROLE_SVT_ADMIN')">
	        ...
	        <div class="nav-item" data-menu-id="customs-support-main">
	            <span class="nav-item-icon">🏢</span> 통관지원 업무(행정)
	            <span style="margin-left: auto; font-size: 12px;">🔽</span>
	        </div>
	        <div class="sub-menu">
	        ...
	        <div class="nav-item" data-menu-id="inspect-main">
	            <span class="nav-item-icon">🔍</span> 통관지원 업무(현장)
	            <span style="margin-left: auto; font-size: 12px;">🔽</span>
	        </div>
	        <div class="sub-menu">
	        	<div class="nav-item" data-menu-id="wh-inventory" onclick="goWHInventoryy()">
	                <span class="nav-item-icon">🏪</span> 보세창고화물내역
	            </div>
		...
		<sec:authorize access="hasRole('ROLE_SVT_MANDARIN')">
	        ...
	        <div class="sub-menu">
	        	<div class="nav-item" data-menu-id="svt-user-mng" onclick="goServantMng()">
	                <span class="nav-item-icon">👥</span> 공무원 계정 관리
	            </div>
	            <div class="nav-item" data-menu-id="user-mng" onclick="goUserMng()">
	                <span class="nav-item-icon">👤</span> 일반이용자 관리
	            </div>
        ...
        <sec:authorize access="hasAnyRole('ROLE_SVT_ADMIN', 'ROLE_SVT_MANDARIN')">
			...
			<div class="sub-menu">
				<div class="nav-item" data-menu-id="my-info" onclick="goMyInfoSvt()">
					<span class="nav-item-icon">👨‍💼</span> 내 정보
				</div>
				<div class="nav-item" data-menu-id="my-calendar" onclick="goMyCalendar()">
					<span class="nav-item-icon">📝</span> 내 일정
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (currentPath !== '/' && currentPath !== '/register/main.do'&& currentPath !== '/register/form.do') {
        restoreSelectedMenu();
    }
});
</script>